...
class ColorInput extends React.Component {
  ...
  render() {
    ...
    return (
      <Box direction="row" gap="small" width="large" margin={{ vertical: 'medium' }}>
        <Text size="medium">{name}</Text>
        <Box align="center" pad={{ horizontal: 'small', vertical: 'small' }} round="small" direction="row" border>
          <StatusDisabledSmall color={color} />
          <TextInput plain size="small" value={color} onChange={this.onChange} />
        </Box>
      </Box>
    );
  }
